...
3. What is the *theme* of the game? Think about the main idea or concept you want to convey through this game. This could be something like the "fantasy of being a spy", "what it feels like to have brain fog in everyday life", or - for a narrative game focused on emotional storytelling - something like "overcoming emotional trauma". Really try to understand this theme and what makes it intriguing for you so you can center all of the game's design around it.
4. *What are you trying to say* with this game? Related to the previous point, think about the particular truth(s) you are trying to convey regarding the theme. Be specific - if you are exploring mental health, for example, decide on a theme like "what it feels like to have brain fog in everyday life" or a message about "the healing power of emotional connection". Understanding the themes or message you want to convey can be another extremely important step as it will basically make design decisions for you (does this mechanic support the game's themes/message?).
